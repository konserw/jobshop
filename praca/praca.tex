...
\item Least Slack Time - Pierwsze jest przetwarzane zadanie którego różnica między czasem potrzebnym do jego ukończenia a czesem pozostałym do terminu zakończenia pracy jest najmniejsza. %Formalnie \cite{slack}
%\begin{math}
%(d - t) - c'
%\end{math}
\item Least Slack Time per Operation - Pierwsze jest przetwarzane zadanie którego stosunek czasu 'Slack' do ilości pozoostałych do wykonania operacji jest najmniejszy. 
...
\item Metoda podziałów i oszacowań - 
